    ...
    if not prompt:
        if lang.startswith("ru"):
            prompt = (
                ...
                "- Используй разговорный сленг и живой язык\n"
            ...
            prompt = (
                ...
                "- Use CENSORSHIP to avoid TikTok bans (replace explicit words with '*', 's-word', etc.)\n"
                "- Profanity is ALLOWED but censored (e.g., 'f*ck', 'sh*t', 'd*mn')\n"
                "- Start with the MOST captivating moment\n"
                "- Use casual slang and conversational language\n"
